...
const Input: FC<InputProps> = ({
  ...
  if (disabled) {
    inputClasses += ` border-gray-300 bg-gray-100 text-gray-600 cursor-not-allowed dark:bg-gray-800 dark:text-gray-300 dark:border-gray-700 focus:ring-0 focus:border-gray-300 dark:focus:border-gray-700`;
  } else if (error) {
